...
const allNavItems: NavItem[] = [
  ...
  { to: '/kasbon', label: 'Kasbon', roles: ['super_admin', 'manager', 'karyawan'], icon: IconReceipt },
  { to: '/cash-flow', label: 'Arus Kas', roles: ['super_admin', 'manager', 'karyawan'], icon: IconWallet },
